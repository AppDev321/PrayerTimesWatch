...
public final class DigitalWatchFaceUtil {
    ...
    /**
     * The {@link DataMap} key for {@link MyPrayerWatchFace} background color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_BACKGROUND_COLOR = "BACKGROUND_COLOR";

    /**
     * The {@link DataMap} key for {@link MyPrayerWatchFace} hour digits color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_HOURS_COLOR = "HOURS_COLOR";

    /**
     * The path for the {@link DataItem} containing {@link MyPrayerWatchFace} configuration.
     */
    ...
    /**
     * Asynchronously fetches the current config {@link DataMap} for {@link MyPrayerWatchFace}
